# System Documentation — Quality and coverage

<!-- alpha8-narrative:overview -->
## Overview

This page is generated directly from the repository's substrate. The tables and citations below summarise everything the analysis pipeline detected for the Quality surface; refer to the cited file paths and line numbers for the source of truth.
...
| File summaries that fell back to a degraded summary | 21 |
| Module summaries that fell back to a degraded summary | 6 |
