# canvas-repo-tfjtizn2 — High-Level Design

_LLM narrative unavailable for this run — the data below is rendered directly from the repository's substrate and is unaffected. With an LLM adapter configured, this page opens with a synthesized framing of index._

## System at a glance

| Dimension | Value |
|---|---|
| Architecture style | _unknown_ |
| Primary domain | _unspecified_ |
| Modules | 6 |
| Parsed files | 21 |
| HTTP routes | 0 |
| Domain entities | 0 |
