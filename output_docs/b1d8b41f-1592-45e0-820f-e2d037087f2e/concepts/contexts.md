# Geospatial indexing and proximity search via quadtree, with an interactive Swing visualization Documentation — Bounded contexts
...
Modules participating in the 'automated code analysis / documentation generation artifacts (for a quadtree-geolocation target repository)' domain.
...
Modules participating in the 'automated code analysis and documentation generation artifacts' domain.

**Modules in this context:**

- `output_docs/d3f23642-6ed9-42be-b97a-c16b381f84d0`
...
Modules participating in the 'automated code analysis and documentation generation pipeline output' domain.
...
Modules participating in the 'automated code analysis and documentation generation pipeline output (target subject: quadtree-geolocation)' domain.

**Modules in this context:**

- `output_docs/d7fc7dbb-946e-47ec-a6f9-d21bd88e1517`
...
Modules participating in the 'automated code analysis and functional documentation generation' domain.

**Modules in this context:**

- `output_docs/fbbd6e79-5648-4a44-8ff9-cc26202c51ac`
...
Modules participating in the 'automated code documentation / analysis pipeline output (subject system: quadtree-based geolocation)' domain.
...
Modules participating in the 'automated code documentation / repository analysis output' domain.

**Modules in this context:**

- `output_docs/f898d313-ec14-439f-8fb3-673849e0a90e`
...
Modules participating in the 'automated code documentation / repository analysis output (subject repo: quadtree-based geolocation)' domain.

**Modules in this context:**

- `output_docs/b8b022df-b5f4-4753-b5d6-7044bd583aaf`
...
Modules participating in the 'automated code documentation / repository analysis pipeline output (target subject: quadtree-based geolocation system)' domain.

**Modules in this context:**

- `output_docs/ac867df2-d266-4fbc-9a56-28912a9cbe7f`
...
Modules participating in the 'automated code documentation / repository analysis reporting' domain.

**Modules in this context:**

- `output_docs/ae442353-f477-4c46-9abc-157eb460184f`
...
Modules participating in the 'automated code documentation generation / repository analysis output (subject repo: quadtree-geolocation)' domain.

**Modules in this context:**

- `output_docs/b2d8d2cb-f4c8-405a-ab26-8a2f6b0fe598`
...
Modules participating in the 'automated code documentation generation / repository analysis pipeline output (analyzing a quadtree geolocation visualization subject system)' domain.

**Modules in this context:**

- `output_docs/b6531516-c93c-4826-af47-74bc7949ec36`
...
Modules participating in the 'automated code/repository analysis and documentation generation pipeline output (target domain: quadtree-based geolocation)' domain.

**Modules in this context:**

- `output_docs/eafeaf72-cba4-4d80-ac1f-4fc7b04cc96d`
...
Modules participating in the 'automated code/repository documentation and analysis pipeline output' domain.

**Modules in this context:**

- `output_docs/f98e26cf-c2f8-4988-853d-25722a971621`
...
Modules participating in the 'automated codebase analysis and documentation generation output' domain.

**Modules in this context:**

- `output_docs/f540a172-bf8b-4bd9-80eb-9851adf6f498`
...
Modules participating in the 'automated codebase documentation generation (analysis pipeline output for a quadtree visualization application)' domain.

**Modules in this context:**

- `output_docs/8cedd601-607c-4234-aede-445c1816e1ca`
...
Modules participating in the 'automated documentation generation pipeline output / artifact storage' domain.
...
Modules participating in the 'automated documentation generation pipeline output / code analysis reports' domain.
...
Modules participating in the 'automated repository documentation / code analysis pipeline output' domain.

**Modules in this context:**

- `output_docs/8931b3bf-b929-4471-b7fa-c042ea95bf72`
...
Modules participating in the 'automated repository documentation / code analysis pipeline output (analyzed subject domain: quadtree-based geolocation)' domain.

**Modules in this context:**

- `output_docs/976d4bea-3fa4-47bf-8b6d-3c704c4fd0f8`
...
Modules participating in the 'automated repository documentation / code analysis report artifact' domain.

**Modules in this context:**

- `output_docs/fb10ebfe-68d8-41f6-9441-0d2f9923d063`
...
Modules participating in the 'code analysis / automated documentation generation pipeline output (analyzed subject domain: quadtree-based geolocation)' domain.

**Modules in this context:**

- `output_docs/fe71554f-60d7-4738-bc59-e4c1a98be1e0`
...
Modules participating in the 'code analysis / automated documentation generation pipeline output (target domain: quadtree-based geolocation)' domain.
...
Modules participating in the 'code analysis / automated repository documentation output' domain.
...
Modules participating in the 'code analysis / documentation generation output artifacts' domain.

**Modules in this context:**

- `output_docs/c7f8292d-49c1-4fad-b076-01327fb153fe`
...
Modules participating in the 'code analysis / repository documentation artifacts (analysis run output for a quadtree-geolocation project)' domain.

**Modules in this context:**

- `output_docs/be8d9b5b-8af3-4346-b060-aa090902dcb9`
...
Modules participating in the 'code analysis / repository documentation generation pipeline output' domain.
...
Modules participating in the 'generated documentation / analysis artifacts for a quadtree-based geolocation system' domain.
...
Modules participating in the 'generated documentation artifacts for a code analysis / reverse-engineering pipeline (target domain: spatial/geolocation visualization via quadtree)' domain.

**Modules in this context:**

- `output_docs/f4132b71-0741-4e5a-930f-537bc1c02d24`
...
Modules participating in the 'generated documentation artifacts for a code analysis pipeline run (target domain: java quadtree geolocation)' domain.

**Modules in this context:**

- `output_docs/e92d6139-d983-43b4-9b32-98b3be673553`
...
Modules participating in the 'generated documentation artifacts for a quadtree-based spatial visualization / graphics application analysis run' domain.
...
Modules participating in the 'repository analysis / automated documentation generation pipeline output' domain.

**Modules in this context:**

- `output_docs/adeda53c-0d7a-4aec-9ebe-b65a585c9af3`
...
Modules participating in the 'repository analysis / automated documentation generation pipeline output (subject repo: quadtree-based geolocation system)' domain.
...
Modules participating in the 'repository analysis / code documentation generation pipeline output (target domain: geolocation via quadtree)' domain.
